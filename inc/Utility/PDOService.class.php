<?php
/**
 * Student Name:            Isaias Bautista
 * Student ID:              300324535
 * Assignment/File Name:    Lab07
 * 
 * Description: 
 * 
 * Application will show data from Studend database
 * it will allow to user to submit a new feedback. 
 * The data table will update with the new data.
 * 
 * References:
 * 
 * Using examples from demonstration 7 and class practice from week 10
 *     
**/
